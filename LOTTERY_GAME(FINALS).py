...
class Ui_MainWindow(object):
    ...
    def superplay_again(self):
        ...
        self.SBALL1.hide(); self.SBALL2.hide(); self.LCDSRES2super.hide(); self.LCDSRES1super.hide(); self.LBLSUPERWINORLOSE.hide(); self.lcdjackpotsuper.display(sjackpot)
        pwallet=str(wallet)
        return sguessnum, pwallet, srands
    ...
    def newuser_action(self):
        ...
        if self.lenameinput.text() == "":
            ...
            self.lblwallet.setText(pwallet);self.lblplayer.setText(user)
            self.wwelcome.hide()
        return pwallet

    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(896, 630)
...
"background-color: rgb(255, 170, 255);")
        self.mbg.setText("")
        self.mbg.setPixmap(QtGui.QPixmap("../lotterygamez/layout1.png"))
        ...
        self.lblogo.setText("")
        self.lblogo.setPixmap(QtGui.QPixmap("../lotterygamez/LOGOLG.png"))
...
"border-color: none;")
        ...
        self.picwallet.setPixmap(QtGui.QPixmap("../lotterygamez/walleticon.png"))
        ...
        self.picplayer.setPixmap(QtGui.QPixmap("../lotterygamez/playericon.png"))
...
"color: rgb(35, 234, 13);")
        ...
        self.lblitem1.setPixmap(QtGui.QPixmap("../lotterygamez/panda.png"))
        ...
        self.lblitem3.setPixmap(QtGui.QPixmap("../lotterygamez/koala.png"))
        ...
        self.lblitem5.setPixmap(QtGui.QPixmap("../lotterygamez/puppy.png"))
        ...
        self.lblitem2.setPixmap(QtGui.QPixmap("../lotterygamez/pig.png"))
        ...
        self.lblitem4.setPixmap(QtGui.QPixmap("../lotterygamez/cat.png"))
        ...
        self.lblitem6.setPixmap(QtGui.QPixmap("../lotterygamez/bear.png"))
...
"color: rgb(35, 234, 13);")
        ...
        self.lblselecttoypic.setPixmap(QtGui.QPixmap("../lotterygamez/black.png"))
...
"color: rgb(0, 248, 32);")
        ...
        self.pbshop_2 = QtWidgets.QPushButton(self.frshop, clicked=lambda: self.buy_action())
...
"}")
        ...
        self.lgpic.setText("")
        self.lgpic.setPixmap(QtGui.QPixmap("../lotterygamez/LG1.png"))
...
"background-color: rgb(255, 170, 255);")
        ...
        self.lbmainbg.setPixmap(QtGui.QPixmap("../lotterygamez/shop.png"))
        ...
        self.lbiconwar.setPixmap(QtGui.QPixmap("../lotterygamez/swords.png"))
...
"background-color: rgb(255, 170, 255);")
        ...
        self.lbmainbg_2.setPixmap(QtGui.QPixmap("../lotterygamez/shop.png"))
...
"}")
        ...
        self.lblselecthorsepic.setPixmap(QtGui.QPixmap("../lotterygamez/horseicongreen.png"))
...
"border-color: rgb(0, 170, 0);")
        ...
        self.lblhorsewipic.setPixmap(QtGui.QPixmap("../lotterygamez/horseicongreen.png"))
        ...
        self.pbseeresultshorse = QtWidgets.QPushButton(self.frracing)
...
"background-color: rgb(255, 170, 255);")
        self.LBLSBG.setText("")
        self.LBLSBG.setPixmap(QtGui.QPixmap("../lotterygamez/shop.png"))
        ...
        self.lbicon.setText("")
        self.lbicon.setPixmap(QtGui.QPixmap("../lotterygamez/supericongreen.png"))
...
"color: rgb(35, 234, 13);")
        self.SBALL1.setText("")
        self.SBALL1.setPixmap(QtGui.QPixmap("../lotterygamez/ball.png"))
...
"color: rgb(35, 234, 13);")
        self.SBALL2.setText("")
        self.SBALL2.setPixmap(QtGui.QPixmap("../lotterygamez/ball.png"))
...
"background-color: rgb(255, 170, 255);")
        self.LBLUBG.setText("")
        self.LBLUBG.setPixmap(QtGui.QPixmap("../lotterygamez/shop.png"))
        ...
        self.lbicon_2.setPixmap(QtGui.QPixmap("../lotterygamez/ultraicongreen.png"))
...
"color: rgb(35, 234, 13);")
        self.UBALL1.setText("")
        self.UBALL1.setPixmap(QtGui.QPixmap("../lotterygamez/ball.png"))
...
"color: rgb(35, 234, 13);")
        self.UBALL2.setText("")
        self.UBALL2.setPixmap(QtGui.QPixmap("../lotterygamez/ball.png"))
...
"color: rgb(35, 234, 13);")
        self.UBALL3.setText("")
        self.UBALL3.setPixmap(QtGui.QPixmap("../lotterygamez/ball.png"))
